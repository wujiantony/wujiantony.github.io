...
Github page does not originally provide LaTeX support. If you want to render your math equations using KaTeX, a JavaScript library for TeX math rendering on the web, you have to do the following steps.
